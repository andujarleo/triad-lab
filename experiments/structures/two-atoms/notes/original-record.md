...
Solver: Strang 3D standalone (mesmo passo de [Fontes/run_q01a.py](../../../quantum/spatial-convergence/code/measure_spatial_convergence.py) / [29 triad_R5_A2](../../../memory/memory-small-amplitude/notes/original-record.md)). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$.
