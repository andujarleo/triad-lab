...
# Comparações visuais adicionais

**O que mostram estas imagens adicionais de campo?**

Registros visuais preservados do material recebido. A execução exata que gerou cada imagem não foi estabelecida; consulte as legendas e a origem antes de associá-las a uma conclusão numérica.
