...
Regime R5 da `[[Equação de referência]]`. N=40 em vez de N=128 (custo CPU). Full vs no-memory. Classe (b). Conceito: [Anti-colapso](../../../../docs/reference/concepts/anti-collapse.md) · [Memória](../../../../docs/reference/concepts/memory.md).
...
![Artefatos/triad_R5_reference_N40/00_montagem.png](../results/figures/overview.png)

## CSVs

- [Artefatos/triad_R5_reference_N40/summary.csv](../results/data/summary.csv)
- [Artefatos/triad_R5_reference_N40/R5_full_metrics.csv](../results/data/memory-model-metrics.csv)
- [Artefatos/triad_R5_reference_N40/R5_no_memory_metrics.csv](../results/data/no-memory-control-metrics.csv)
...
→ [17 triad_R5_reference_N48_full](../../memory-grid-48/notes/original-record.md) · [18 triad_visual_atlas](../../../geometry/visual-atlas/notes/original-record.md)
