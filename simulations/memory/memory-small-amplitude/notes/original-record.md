...
Equação TRIAD **completa** (mode=full) da spec canônica v1.0 [triad_equation_reference](../../../../docs/reference/records/triad-equation-reference.md) **A.2** R5-FDT. IC §9.1: **1 gaussiana = 1 átomo**, $s=0.5$, $k_0=0$, $y_j(0)=0$, $\int|\Psi|^2=1$. **Não é ablação.** Sem §6, sem zerar $\lambda$, sem fit de $k_*L$. [Memória](../../../../docs/reference/concepts/memory.md) · [FDT](../../../../docs/reference/concepts/fdt.md) · [Universo como simulação](../../../../docs/reference/concepts/universe-as-simulation.md) · `[[Equação de referência]]`
...
![Artefatos/triad_R5_A2/01_ic_isosurface.png](../results/figures/ic-isosurface.png)

![Artefatos/triad_R5_A2/02_isosurface_early.png](../results/figures/isosurface-early.png)
...
Não substitui [27 triad_chaos_eq](../../../structures/twelve-atoms-full-field/notes/original-record.md) nem [28 triad_atoms_3d](../../../structures/3d-atom-trajectories/notes/original-record.md).
...
$k_*L$ late=9.424778 (casca não-DC mais baixa; igual ao [16 triad_R5_reference_N40](../../memory-grid-40/notes/original-record.md)). Spec §10.4 cita ~16.3 em N=128 — **não** calibrado aqui.

![Artefatos/triad_R5_A2/03_isosurface_mid.png](../results/figures/isosurface-mid.png)

![Artefatos/triad_R5_A2/04_isosurface_late.png](../results/figures/isosurface-late.png)

![Artefatos/triad_R5_A2/05_observables.png](../results/figures/observables.png)

![Artefatos/triad_R5_A2/00_montagem.png](../results/figures/overview.png)

## O que os números sustentam

Com A.2 R5-FDT ($\Gamma=0.01$, $T_{\mathrm{bath}}=0.001$) a semente §9.1 permanece 1 átomo visível no t=0 e se espalha até preencher a caixa (R_rms 0.61→10.02, PR 1.97→4036, norma 1→2.816). Leitura: **1 átomo → universo no cubo**. Mesma família de preenchimento que [27 triad_chaos_eq](../../../structures/twelve-atoms-full-field/notes/original-record.md) / [28 triad_atoms_3d](../../../structures/3d-atom-trajectories/notes/original-record.md), IC canônico em vez da nuvem de 12. Este run **não** recalibrou FDT nem $k_*L$.

## CSVs

- [Artefatos/triad_R5_A2/summary.csv](../results/data/summary.csv)
- [Artefatos/triad_R5_A2/metrics.csv](../results/data/metrics.csv)
- [Artefatos/triad_R5_A2/summary.json](../results/data/summary.json)
...
Script: [Fontes/run_R5_A2.py](../code/simulate_memory_small_amplitude.py)
