...
# Mapa de templates Bravais

Pós-processamento FFT/templates do run de bounce; as pontuações dependem desse diagnóstico.
...
[Condições e contrastes registrados](../../../docs/pt-BR/execution-audit.md#study-t-24) · [original-record.md](notes/original-record.md#L10)

## Material disponível

12 arquivos associados à ficha: 2 `.csv`, 1 `.md`, 9 `.png`.

[Cronologia](../../../docs/pt-BR/topics/timeline.md) · [← 23](../../memory/memory-and-bounce/README.pt-BR.md) · [25 →](../first-geometric-network/README.pt-BR.md)
