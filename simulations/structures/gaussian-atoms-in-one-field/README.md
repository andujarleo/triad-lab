...
# Gaussian atoms in one field

Several Gaussian initial structures share a field and may lose their separate identities.
...
**Execution not fully traceable.** Multi-Gaussian exploration has figures but no saved source or CSV.

[Conditions and recorded contrasts](../../../docs/en/execution-audit.md#study-t-04) · [original-record.md](notes/original-record.md#L10)

## Available material

8 files associated with this entry: 1 `.md`, 7 `.png`.

[Timeline](../../../docs/en/topics/timeline.md) · [← 03](../../memory/tracking-density-peaks/README.md) · [05 →](../individual-fields/README.md)
