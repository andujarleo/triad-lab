...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](../../../../docs/reference/records/triad-qm-canonical-v1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. Duas sementes, separação 6 ao longo de x. Leitura: par (queda?) e pico finito (singularidade que não vai a infinito). Volume preenchido = universo, não ruído. **Não** é teste de interferência. Sem isolar memória/FDT. Sem mudar Theta_core para o par atrair. [Leitura operacional](../../../../docs/reference/concepts/operational-readings.md) · [Anti-colapso](../../../../docs/reference/concepts/anti-collapse.md) · [Universo como simulação](../../../../docs/reference/concepts/universe-as-simulation.md)

Solver: Strang 3D standalone (mesmo passo de [Fontes/run_q01a.py](../../../field-diagnostics/spatial-convergence/code/measure_spatial_convergence.py) / [29 triad_R5_A2](../../../memory/memory-small-amplitude/notes/original-record.md)). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$.
...
![Artefatos/triad_dois_atomos/01_ic_isosurface.png](../results/figures/ic-isosurface.png)

![Artefatos/triad_dois_atomos/04a_midplane_t0.png](../results/figures/04a-midplane-t0.png)
...
Não substitui [27 triad_chaos_eq](../../twelve-atoms-full-field/notes/original-record.md) · [28 triad_atoms_3d](../../3d-atom-trajectories/notes/original-record.md) · [29 triad_R5_A2](../../../memory/memory-small-amplitude/notes/original-record.md) · Q01a.
...
Os dois átomos **permanecem 2 só até t=0.01**. Em t=0.02 o detector já conta 29–30 máximos e R_rms já é $\approx L/2$. Em t=0.1 n_raw=3603, norm=327 — a mesma família de preenchimento de Q01a / [27 triad_chaos_eq](../../twelve-atoms-full-field/notes/original-record.md) com este banho. **Com kT=1 as duas sementes viram universo antes de um par-órbita poder ser lido.** kT não foi retocado. Isso é o resultado.
...
![Artefatos/triad_dois_atomos/01b_isosurface_early.png](../results/figures/01b-isosurface-early.png)

![Artefatos/triad_dois_atomos/02_isosurface_mid.png](../results/figures/isosurface-mid.png)

![Artefatos/triad_dois_atomos/03_isosurface_late.png](../results/figures/isosurface-late.png)

![Artefatos/triad_dois_atomos/04_midplane_xy.png](../results/figures/midplane-xy.png)

![Artefatos/triad_dois_atomos/05_observables.png](../results/figures/observables.png)

![Artefatos/triad_dois_atomos/07_early_zoom.png](../results/figures/early-zoom.png)

![Artefatos/triad_dois_atomos/00_montagem.png](../results/figures/overview.png)
...
- [Artefatos/triad_dois_atomos/summary.csv](../results/data/summary.csv)
- [Artefatos/triad_dois_atomos/metrics.csv](../results/data/metrics.csv)
- [Artefatos/triad_dois_atomos/summary.json](../results/data/summary.json)
...
Script: [Fontes/run_dois_atomos.py](../code/simulate_two_atoms.py)
