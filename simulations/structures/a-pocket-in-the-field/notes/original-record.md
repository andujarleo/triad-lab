...
Protocolo: [PROTOCOL_37](protocol.md). O que a gente achava antes: [predictions_37](predictions.md). Números: `Artefatos/triad_bolso_37/`.
...
[32 universo_atomo](../../atom-inside-a-larger-gaussian/notes/original-record.md) · [35 singularidade_finita](../../finite-peak-early-window/notes/original-record.md) · [38 dois_bolsos](../../two-pockets/notes/original-record.md) · `[[TRIAD]]`
