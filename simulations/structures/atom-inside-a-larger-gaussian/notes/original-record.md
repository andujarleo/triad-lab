...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](../../../../docs/reference/records/triad-qm-canonical-v1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. **OUTER larga = o universo** (um átomo gigante). **Dentro:** observador e observado, fases 0 e π (+ e −). Leitura: **anti-colapso / ímã-repele** (memória mesmo-polo, singularidade finita) — **não** MQ, **não** colapso-como-gravidade-caindo. Volume preenchido = universo, não ruído. Sem isolar memória/FDT. Sem mudar Theta_core. Sem retocar kT. [Leitura operacional](../../../../docs/reference/concepts/operational-readings.md) · [Anti-colapso](../../../../docs/reference/concepts/anti-collapse.md) · [Universo como simulação](../../../../docs/reference/concepts/universe-as-simulation.md)
...
![Artefatos/triad_universo_atomo/01_ic_isosurface.png](../results/figures/ic-isosurface.png)

![Artefatos/triad_universo_atomo/01e_ic_re_isosurface.png](../results/figures/01e-ic-re-isosurface.png)

![Artefatos/triad_universo_atomo/04g_midplane_re_t0.png](../results/figures/04g-midplane-re-t0.png)

![Artefatos/triad_universo_atomo/09b_linecut_re_t0.png](../results/figures/09b-linecut-re-t0.png)

![Artefatos/triad_universo_atomo/06_radial_profiles.png](../results/figures/radial-profiles.png)
...
![Artefatos/triad_universo_atomo/01d_isosurface_t001.png](../results/figures/01d-isosurface-t001.png)

![Artefatos/triad_universo_atomo/01c_isosurface_t002.png](../results/figures/01c-isosurface-t002.png)

![Artefatos/triad_universo_atomo/01b_isosurface_early.png](../results/figures/01b-isosurface-early.png)

![Artefatos/triad_universo_atomo/02_isosurface_mid.png](../results/figures/isosurface-mid.png)

![Artefatos/triad_universo_atomo/03_isosurface_late.png](../results/figures/isosurface-late.png)

![Artefatos/triad_universo_atomo/04r_midplane_re.png](../results/figures/04r-midplane-re.png)

![Artefatos/triad_universo_atomo/04_midplane_xy.png](../results/figures/midplane-xy.png)

![Artefatos/triad_universo_atomo/05_observables.png](../results/figures/observables.png)

![Artefatos/triad_universo_atomo/07_early_zoom.png](../results/figures/early-zoom.png)

![Artefatos/triad_universo_atomo/08_nest3.png](../results/figures/nest3.png)

![Artefatos/triad_universo_atomo/09_linecut_re.png](../results/figures/linecut-re.png)

![Artefatos/triad_universo_atomo/00_montagem.png](../results/figures/overview.png)
...
- [Artefatos/triad_universo_atomo/summary.csv](../results/data/summary.csv)
- [Artefatos/triad_universo_atomo/metrics.csv](../results/data/metrics.csv)
- [Artefatos/triad_universo_atomo/radial_profiles.csv](../results/data/radial_profiles.csv)
- [Artefatos/triad_universo_atomo/linecut_re.csv](../results/data/linecut_re.csv)
- [Artefatos/triad_universo_atomo/summary.json](../results/data/summary.json)
...
Script: [Fontes/run_universo_atomo.py](../code/simulate_atom_inside_gaussian.py)
