...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](../../../../docs/reference/records/triad-qm-canonical-v1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. **Inner atom INSIDE the outer atom**, mesmo centro. Outer fase 0 (+), inner fase π (−). Leitura: **ímã / anti-colapso** (ninho de sinal, singularidade finita) — **não** lado-a-lado como [32 universo_atomo](../../atom-inside-a-larger-gaussian/notes/original-record.md), **não** ninho mesmo-sinal como [31 nested_gaussians](../../nested-positive-gaussians/notes/original-record.md). Volume preenchido = universo, não ruído. Sem isolar memória/FDT. Sem mudar Theta_core. Sem retocar kT. [Leitura operacional](../../../../docs/reference/concepts/operational-readings.md) · [Anti-colapso](../../../../docs/reference/concepts/anti-collapse.md) · [Universo como simulação](../../../../docs/reference/concepts/universe-as-simulation.md)

Solver: Strang 3D standalone (mesmo passo de [Fontes/run_q01a.py](../../../field-diagnostics/spatial-convergence/code/measure_spatial_convergence.py) / [30 dois_atomos_gravidade](../../two-atoms/notes/original-record.md) / [31 nested_gaussians](../../nested-positive-gaussians/notes/original-record.md)). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$.
...
![Artefatos/triad_ninho_pm/01_ic_isosurface.png](../results/figures/ic-isosurface.png)

![Artefatos/triad_ninho_pm/01e_ic_re_isosurface.png](../results/figures/01e-ic-re-isosurface.png)

![Artefatos/triad_ninho_pm/04g_midplane_re_t0.png](../results/figures/04g-midplane-re-t0.png)

![Artefatos/triad_ninho_pm/09b_linecut_re_t0.png](../results/figures/09b-linecut-re-t0.png)

![Artefatos/triad_ninho_pm/06_radial_profiles.png](../results/figures/radial-profiles.png)

![Artefatos/triad_ninho_pm/06b_radial_linear.png](../results/figures/06b-radial-linear.png)
...
Não substitui [27 triad_chaos_eq](../../twelve-atoms-full-field/notes/original-record.md) · [28 triad_atoms_3d](../../3d-atom-trajectories/notes/original-record.md) · [29 triad_R5_A2](../../../memory/memory-small-amplitude/notes/original-record.md) · [30 dois_atomos_gravidade](../../two-atoms/notes/original-record.md) · [31 nested_gaussians](../../nested-positive-gaussians/notes/original-record.md) · [32 universo_atomo](../../atom-inside-a-larger-gaussian/notes/original-record.md) · Q01a.
...
![Artefatos/triad_ninho_pm/01d_isosurface_t001.png](../results/figures/01d-isosurface-t001.png)

![Artefatos/triad_ninho_pm/01c_isosurface_t002.png](../results/figures/01c-isosurface-t002.png)

![Artefatos/triad_ninho_pm/01f_t002_re_isosurface.png](../results/figures/01f-t002-re-isosurface.png)

![Artefatos/triad_ninho_pm/01b_isosurface_early.png](../results/figures/01b-isosurface-early.png)

![Artefatos/triad_ninho_pm/02_isosurface_mid.png](../results/figures/isosurface-mid.png)

![Artefatos/triad_ninho_pm/03_isosurface_late.png](../results/figures/isosurface-late.png)

![Artefatos/triad_ninho_pm/04r_midplane_re.png](../results/figures/04r-midplane-re.png)

![Artefatos/triad_ninho_pm/04_midplane_xy.png](../results/figures/midplane-xy.png)

![Artefatos/triad_ninho_pm/05_observables.png](../results/figures/observables.png)

![Artefatos/triad_ninho_pm/07_early_zoom.png](../results/figures/early-zoom.png)

![Artefatos/triad_ninho_pm/08_two_scale.png](../results/figures/two-scale.png)

![Artefatos/triad_ninho_pm/09_linecut_re.png](../results/figures/linecut-re.png)

![Artefatos/triad_ninho_pm/00_montagem.png](../results/figures/overview.png)
...
- [Artefatos/triad_ninho_pm/summary.csv](../results/data/summary.csv)
- [Artefatos/triad_ninho_pm/metrics.csv](../results/data/metrics.csv)
- [Artefatos/triad_ninho_pm/radial_profiles.csv](../results/data/radial_profiles.csv)
- [Artefatos/triad_ninho_pm/linecut_re.csv](../results/data/linecut_re.csv)
- [Artefatos/triad_ninho_pm/summary.json](../results/data/summary.json)
...
Script: [Fontes/run_ninho_pm.py](../code/simulate_signed_gaussian_nest.py)
