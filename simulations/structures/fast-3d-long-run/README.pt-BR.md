...
# Execução longa 3D rápida

Figuras preservadas de uma execução exploratória 3D de custo reduzido.
...
[Cronologia](../../../docs/pt-BR/topics/timeline.md) · [← 11](../long-run-attempt/README.pt-BR.md) · [13 →](../compact-3d-long-run/README.pt-BR.md)
