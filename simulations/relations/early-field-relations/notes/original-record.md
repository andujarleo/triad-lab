...
Antecede a `[[Equação de referência]]`. Campo 2D visual: duas entidades gaussianas + termo relacional. Quadro: [Universo como simulação](../../../../docs/reference/concepts/universe-as-simulation.md).
...
![Artefatos/triad_sim/00_montagem_simulacao.png](../results/figures/simulation-overview.png)
