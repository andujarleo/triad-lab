...
# Relações iniciais do campo

Relações exploratórias em 2D anteriores à especificação de referência.
...
[Cronologia](../../../docs/pt-BR/topics/timeline.md) · [02 →](../../memory/memory-and-thermal-noise/README.pt-BR.md)
