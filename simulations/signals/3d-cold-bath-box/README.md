...
11 file associated with this entry: 2 `.csv`, 1 `.gif`, 1 `.md`, 7 `.png`.

[Timeline](../../../docs/en/topics/timeline.md) · [← 19](../hot-bath-diagnostic-failure/README.md) · [21 →](../first-phase-to-density-diagnostic/README.md)
