...
# Primeiro diagnóstico de fase para densidade

O primeiro estimador de propagação devolveu velocidades próximas de zero e permanece como falha diagnóstica.
...
13 arquivos associados à ficha: 2 `.csv`, 1 `.md`, 10 `.png`.

[Cronologia](../../../docs/pt-BR/topics/timeline.md) · [← 20](../3d-cold-bath-box/README.pt-BR.md) · [22 →](../refined-phase-to-density-diagnostic/README.pt-BR.md)
