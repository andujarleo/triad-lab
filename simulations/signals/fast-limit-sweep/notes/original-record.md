...
Refaz [06 triad_limit_test](../../limit-test-attempt/notes/original-record.md). Varredura N={2,4,8,12}, r={4,6,8}. Mede a_R, R0, Rfinal, deltaR.
...
Sem `00_montagem`. CSV: [Artefatos/triad_limit_test_fast/limit_results.csv](../results/data/limit_results.csv)

## Arquivos

`01_heatmap.png` · `02_curves.png` · `03_N_scaling.png` · `04_r_scaling.png` · `05_summary.png` · `limit_results.csv`

![Artefatos/triad_limit_test_fast/01_heatmap.png](../results/figures/heatmap.png)
