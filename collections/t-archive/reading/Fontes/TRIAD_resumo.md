> Reading copy / Cópia de leitura. Obsidian links converted for GitHub; original wording and recorded results retained. Unresolved references stay visible as code. [Original](../../source/Fontes/TRIAD_resumo.md) · [Collection / Acervo](../../README.md)
...
- Equação: `[[Equação de referência]]` · [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md)
- Memória / anti-colapso: [Memória](../Conceitos/Mem%C3%B3ria.md) · [Anti-colapso](../Conceitos/Anti-colapso.md)
...
- Tudo junto: [00 registro_completo](TRIAD_registro_completo_simulacoes_2026-08-21.md)
