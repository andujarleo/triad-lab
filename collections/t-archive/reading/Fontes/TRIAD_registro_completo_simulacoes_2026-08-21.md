> Reading copy / Cópia de leitura. Obsidian links converted for GitHub; original wording and recorded results retained. Unresolved references stay visible as code. [Original](../../source/Fontes/TRIAD_registro_completo_simulacoes_2026-08-21.md) · [Collection / Acervo](../../README.md)
...
- [Índice 01–36 — Índice de runs](TRIAD_registro_completo_simulacoes_2026-08-21.md)
- [Q00–Q04 — Programa QM](TRIAD_registro_completo_simulacoes_2026-08-21.md)
...
|---|---|---|---|---|
| 1 | [triad_sim](../Simula%C3%A7%C3%B5es/01%20triad_sim.md) | Exploratória / pré-referência | completo | visual 2D, duas gaussianas + termo relacional; sem CSV |
| 2 | [triad_nls_fdt](../Simula%C3%A7%C3%B5es/02%20triad_nls_fdt.md) | Exploratória / pré-referência | completo | primeiro NLS+memória+FDT; visual |
| 3 | [triad_nls_fdt_v2](../Simula%C3%A7%C3%B5es/03%20triad_nls_fdt_v2.md) | Exploratória / pré-referência | completo | v2 + trajetórias de picos; visual |
| 4 | [triad_atoms_gaussians](../Simula%C3%A7%C3%B5es/04%20triad_atoms_gaussians.md) | Exploratória / pré-referência | completo | átomos gaussianos; visual |
| 5 | [triad_atoms_individual_fields](../Simula%C3%A7%C3%B5es/05%20triad_atoms_individual_fields.md) | Exploratória / pré-referência | completo | identidades gaussianas separadas; visual |
| 6 | [triad_limit_test](../Simula%C3%A7%C3%B5es/06%20triad_limit_test.md) | Tentativa sem artefatos | vazio | cronologia |
| 7 | [triad_limit_test_fast](../Simula%C3%A7%C3%B5es/07%20triad_limit_test_fast.md) | Exploratória quantitativa | completo | N={2,4,8,12} r={4,6,8}; δR>0 só N=2,r=4 |
| 8 | [triad_observer_observed_consciousness](../Simula%C3%A7%C3%B5es/08%20triad_observer_observed_consciousness.md) | Exploratória | completo | mean_abs_C 0 vs 0.140886; R quase idêntico |
| 9 | [triad_field_consciousness_test](../Simula%C3%A7%C3%B5es/09%20triad_field_consciousness_test.md) | Exploratória | completo | bounce_amplitude=0; C_memory_corr=−0.385509 |
| 10 | [triad_3d_anticollapse_test](../Simula%C3%A7%C3%B5es/10%20triad_3d_anticollapse_test.md) | Exploratória 3D / pré-ref | completo | visual |
| 11 | [triad_3d_longrun](../Simula%C3%A7%C3%B5es/11%20triad_3d_longrun.md) | Tentativa sem artefatos | vazio | cronologia |
| 12 | [triad_3d_longrun_fast](../Simula%C3%A7%C3%B5es/12%20triad_3d_longrun_fast.md) | Exploratória 3D | completo | visual; sem 00_montagem |
| 13 | [triad_3d_longrun_compact](../Simula%C3%A7%C3%B5es/13%20triad_3d_longrun_compact.md) | Exploratória 3D | completo | visual |
| 14 | [triad_R5_reference_run](../Simula%C3%A7%C3%B5es/14%20triad_R5_reference_run.md) | Transição | vazio | preparação R5 |
| 15 | [triad_R5_reference_fast](../Simula%C3%A7%C3%B5es/15%20triad_R5_reference_fast.md) | Transição | vazio | preparação R5 |
| 16 | [triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md) | Equação de referência | completo | anti-colapso full vs no-memory |
| 17 | [triad_R5_reference_N48_full](../Simula%C3%A7%C3%B5es/17%20triad_R5_reference_N48_full.md) | Equação de referência | completo | scores Bravais; BCC maior, não “perfeito” |
| 18 | [triad_visual_atlas](../Simula%C3%A7%C3%B5es/18%20triad_visual_atlas.md) | Diagnóstico visual | completo | 22 painéis; sem cancelamento local |
| 19 | [triad_bigbang_solver_run](../Simula%C3%A7%C3%B5es/19%20triad_bigbang_solver_run.md) | solver.py NumPy shim | falha-diagnóstica | FDT quente; mass_final=8773.747757 |
| 20 | [triad_bigbang_3d_box](../Simula%C3%A7%C3%B5es/20%20triad_bigbang_3d_box.md) | solver.py NumPy shim | completo | FDT frio; expansão sem teia clara |
| 21 | [triad_phase_to_density_speed](../Simula%C3%A7%C3%B5es/21%20triad_phase_to_density_speed.md) | solver.py | falha-diagnóstica | velocidades ~4.008763e-16 |
| 22 | [triad_phase_to_density_speed_refined](../Simula%C3%A7%C3%B5es/22%20triad_phase_to_density_speed_refined.md) | solver.py | completo | fronts 7.301417 / 7.557409 |
| 23 | [triad_memory_bounce_bigbang](../Simula%C3%A7%C3%B5es/23%20triad_memory_bounce_bigbang.md) | solver.py | completo | R_rms False; raios de massa True |
| 24 | [triad_bravais_map](../Simula%C3%A7%C3%B5es/24%20triad_bravais_map.md) | Pós-processamento bounce | completo | PLANAR_cross=0.221126 (maior) |
| 25 | [triad_bravais_network_map](../Simula%C3%A7%C3%B5es/25%20triad_bravais_network_map.md) | Pós-processamento geométrico | falha-diagnóstica | 2 nós, 1 aresta; threshold severo |
| 26 | [triad_bravais_network_map_v2](../Simula%C3%A7%C3%B5es/26%20triad_bravais_network_map_v2.md) | Pós-processamento geométrico | completo | t=4.4: 39 nós, 25 arestas |
| 27 | [triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) | solver real (triad-lang), N=32, 2026-08-20 noite | caos-eq | 12 sementes → universo; n_det 12→1238; norm 1→25585.351298 |
| 28 | [triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md) | solver real (triad-lang), N=40 volume 3D, 2026-08-20 noite | caos-eq | 12 sementes 3D → universo no cubo; n_det 12→1007; norm 1→23.275045 |
| 29 | [triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md) | spec §5 3D Strang standalone, N=96 vs 128, 2026-08-20 noite | R5-FDT | 1 átomo §9.1 A.2 → universo no cubo; peak 1.437→0.004433; PR 1.969→4035.967; R_rms 0.612→10.023 |
| 30 | [triad_dois_atomos](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) | Theta_core I0, 2 gaussianas, N=64, 2026-08-21 | par / pico finito | 2 blobs só até t=0.01 (sep 6.000→6.021); t=0.02 universo (n_raw 30, R_rms 15.88); peak_max=4.770 finito; norm 1→18033 |
| 31 | [triad_nested](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) | Theta_core I0, 2 gaussianas aninhadas, N=64, 2026-08-21 | ninho / pico finito | two-scale até t=0.02 (cim 7.89→6.67); t=0.03 universo (R_rms 15.91); peak_max=4.525 finito; norm 1→18022 |
| 32 | [triad_universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md) | Theta_core I0, universo-átomo + par +/−, N=64, 2026-08-21 | ninho 3 / ímã-repele / pico finito | par +/− só em t=0 (sep=5.000); t=0.01 universo (n_raw 8608, R_rms 15.85); peak_max=4.599 finito; norm 1→18029 |
| 33 | [triad_ninho_pm](../Simula%C3%A7%C3%B5es/33%20ninho_pm.md) | Theta_core I0, ninho +/− concêntrico, N=64, 2026-08-21 | ninho sinal / oco / pico finito | oco +/− até t=0.04 (sign até 0.08, flicker t=1.0); t=0.01 universo (R_rms 15.77); peak_max=4.452 finito; norm 1→18022 |
| 34 | [triad_ninho_pm_long](../Simula%C3%A7%C3%B5es/34%20ninho_pm_long.md) | Theta_core I0, ninho +/− T=60, N=64, 2026-08-21 | universo preenchido / sem rebirth | depois de t=1 só universo; sem nest/par/bounce real; peak_max=4.851 em t=10.4 depois platô ~3.31; late norm 32591±72; cryst Δ=2e-6 |
| 35 | [triad_singularidade_35](../Simula%C3%A7%C3%B5es/35%20singularidade_finita.md) | Theta_core I0, 1 e 2 picos, N=64 T=1, 2026-08-21 | singularidade finita | 1atom peak_max=5.3739 t=0.185 n_células 1→1 t_gone=0.005 não aperta; 2atom peak_max=4.76867 t=0.705 n_células 2→1 t_gone=0.005 não aperta |
| 36 | [reexecucao_integral](../Simula%C3%A7%C3%B5es/36%20reexecucao_integral.md) · [TRIAD_reexecucao_integral_2026-08-21](TRIAD_reexecucao_integral_2026-08-21.md) | reexecução dossiê Grok, Linux/NumPy fp64, 21/08/2026 | completo | A.3 64/128/160 H_plateau; P1/P4 PARTIAL; P2/P3/P5/P6 MATCH; CHSH S=2.023±0.092; bandas INCONCLUSIVO; túnel sujo; banho PARTIAL; k*L=3π; Bravais chão |

Classes: [Registro integral](Registro%20integral.md). Equação: `[[Equação de referência]]`. Conceitos: [Anti-colapso](../Conceitos/Anti-colapso.md) · [Bounce](../Conceitos/Bounce.md) · [Rede Bravais](../Conceitos/Rede%20Bravais.md) · [Phase-to-density](../Conceitos/Phase-to-density.md) · [Observador e campo C](../Conceitos/Observador%20e%20campo%20C.md) · [FDT](../Conceitos/FDT.md) · [Memória](../Conceitos/Mem%C3%B3ria.md) · [Leitura operacional](../Conceitos/Leitura%20operacional.md).
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
Primeira tentativa de NLS + [Memória](../Conceitos/Mem%C3%B3ria.md) + [FDT](../Conceitos/FDT.md). Posteriormente revista em [03 triad_nls_fdt_v2](../Simula%C3%A7%C3%B5es/03%20triad_nls_fdt_v2.md). Ainda não é o `[[Solver]]` da fase (c).
...
Repetir [02 triad_nls_fdt](../Simula%C3%A7%C3%B5es/02%20triad_nls_fdt.md) com picos rastreados.
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md) · [Memória](../Conceitos/Mem%C3%B3ria.md) · [FDT](../Conceitos/FDT.md)
...
Saída visual de nuvem em evolução. Esta versão **antecede** a correção de manter identidades explicitamente separadas — ver [05 triad_atoms_individual_fields](../Simula%C3%A7%C3%B5es/05%20triad_atoms_individual_fields.md). Sem CSV.
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md) · [Memória](../Conceitos/Mem%C3%B3ria.md)
...
Correção metodológica sobre [04 triad_atoms_gaussians](../Simula%C3%A7%C3%B5es/04%20triad_atoms_gaussians.md): cada gaussiana mantém identidade própria. Campos podem se sobrepor/interagir sem fundir numa única identidade.
...
Diretório sem arquivos. O teste foi refeito em [07 triad_limit_test_fast](../Simula%C3%A7%C3%B5es/07%20triad_limit_test_fast.md). Mantido para não apagar a cronologia. Sem CSV, sem métrica.

Ver regra de integridade: [Registro integral](Registro%20integral.md).
...
Refaz [06 triad_limit_test](../Simula%C3%A7%C3%B5es/06%20triad_limit_test.md). Varredura N={2,4,8,12}, r={4,6,8}. Mede a_R, R0, Rfinal, deltaR.
...
→ [09 triad_field_consciousness_test](../Simula%C3%A7%C3%B5es/09%20triad_field_consciousness_test.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
→ [08 triad_observer_observed_consciousness](../Simula%C3%A7%C3%B5es/08%20triad_observer_observed_consciousness.md) · [Bounce](../Conceitos/Bounce.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
→ [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
Diretório sem arquivos. Resultados efetivos em [12 triad_3d_longrun_fast](../Simula%C3%A7%C3%B5es/12%20triad_3d_longrun_fast.md) e [13 triad_3d_longrun_compact](../Simula%C3%A7%C3%B5es/13%20triad_3d_longrun_compact.md). Cronologia mantida. [Registro integral](Registro%20integral.md)
...
→ [13 triad_3d_longrun_compact](../Simula%C3%A7%C3%B5es/13%20triad_3d_longrun_compact.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
→ [12 triad_3d_longrun_fast](../Simula%C3%A7%C3%B5es/12%20triad_3d_longrun_fast.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
Sem artefatos. Tentativa substituída por [15 triad_R5_reference_fast](../Simula%C3%A7%C3%B5es/15%20triad_R5_reference_fast.md) / [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md). Sem CSV. Cronologia: [Registro integral](Registro%20integral.md).

→ [Anti-colapso](../Conceitos/Anti-colapso.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
Sem artefatos. Resultados efetivos começam em [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md). Sem CSV.
...
→ [17 triad_R5_reference_N48_full](../Simula%C3%A7%C3%B5es/17%20triad_R5_reference_N48_full.md) · [18 triad_visual_atlas](../Simula%C3%A7%C3%B5es/18%20triad_visual_atlas.md)
...
→ [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md) · [24 triad_bravais_map](../Simula%C3%A7%C3%B5es/24%20triad_bravais_map.md)
...
→ [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md) · [Memória](../Conceitos/Mem%C3%B3ria.md) · [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md)
...
Crescimento de massa/norma associado ao FDT quente. Permanece. Motivou [20 triad_bigbang_3d_box](../Simula%C3%A7%C3%B5es/20%20triad_bigbang_3d_box.md).
...
→ [FDT](../Conceitos/FDT.md) · [Registro integral](Registro%20integral.md)
...
Resposta ao FDT quente de [19 triad_bigbang_solver_run](../Simula%C3%A7%C3%B5es/19%20triad_bigbang_solver_run.md). Grid 44³, L=32, dt=0.0025, T=10; FDT muito frio. `[[Solver]]` via shim. [FDT](../Conceitos/FDT.md)
...
`density_front_speed≈4.008763e-16`, `phase_front_speed≈4.008763e-16`. Slopes low-k ≈1.045503e-15 e 6.580752e-17. Resultado zero/degenerado. Levou a [22 triad_phase_to_density_speed_refined](../Simula%C3%A7%C3%B5es/22%20triad_phase_to_density_speed_refined.md).
...
→ [Registro integral](Registro%20integral.md) · `[[Solver]]`
...
Protocolo refinado após a falha de [21 triad_phase_to_density_speed](../Simula%C3%A7%C3%B5es/21%20triad_phase_to_density_speed.md). [Phase-to-density](../Conceitos/Phase-to-density.md) · `[[Solver]]`
...
Pós-proc: [24 triad_bravais_map](../Simula%C3%A7%C3%B5es/24%20triad_bravais_map.md) · [25 triad_bravais_network_map](../Simula%C3%A7%C3%B5es/25%20triad_bravais_network_map.md) · [26 triad_bravais_network_map_v2](../Simula%C3%A7%C3%B5es/26%20triad_bravais_network_map_v2.md)
...
Pós-processamento de [23 triad_memory_bounce_bigbang](../Simula%C3%A7%C3%B5es/23%20triad_memory_bounce_bigbang.md) — sem reintegrar. FFT 3D da densidade, shell dominante, templates angulares. [Rede Bravais](../Conceitos/Rede%20Bravais.md)
...
Melhor match: PLANAR_cross. Diferente do R5 N48, onde BCC foi o maior noutro detector/regime ([17 triad_R5_reference_N48_full](../Simula%C3%A7%C3%B5es/17%20triad_R5_reference_N48_full.md)). Não unificar.
...
Primeira rede: picos de densidade → nós; arestas por proximidade/kNN. Threshold severo demais. Preservado. Motivou [26 triad_bravais_network_map_v2](../Simula%C3%A7%C3%B5es/26%20triad_bravais_network_map_v2.md). [Rede Bravais](../Conceitos/Rede%20Bravais.md)
...
→ [Registro integral](Registro%20integral.md)
...
Rede refinada após [25 triad_bravais_network_map](../Simula%C3%A7%C3%B5es/25%20triad_bravais_network_map.md). Snapshot automático “mais estruturado”. [Rede Bravais](../Conceitos/Rede%20Bravais.md)
...
→ [23 triad_memory_bounce_bigbang](../Simula%C3%A7%C3%B5es/23%20triad_memory_bounce_bigbang.md) · [24 triad_bravais_map](../Simula%C3%A7%C3%B5es/24%20triad_bravais_map.md) · `[[TRIAD]]`
...
Não é o IC de #23 (uma gaussiana larga σ=3.2 + chirp). Não substitui [23 triad_memory_bounce_bigbang](../Simula%C3%A7%C3%B5es/23%20triad_memory_bounce_bigbang.md).
...
Mesma família de [19 triad_bigbang_solver_run](../Simula%C3%A7%C3%B5es/19%20triad_bigbang_solver_run.md) (FDT quente; lá mass_final=8773.747757). Aqui o default `fdt_couple=True` com dx=1 injeta massa ~O(1) por passo; norma 1→25585.351298. #23 no mesmo Λ,ν,λ,Γ teve norma 1→1.491662 (N=40, IC diferente, FDT efetivo não registrado na nota). Este run **não** recalibrou FDT.

![Artefatos/triad_chaos_eq/00_montagem.png](../../source/Artefatos/triad_chaos_eq/00_montagem.png)

### O que os números sustentam

Com o FDT default em N=32, as 12 sementes deixam de ser o estado inteiro em Δt=0.1. O que assenta é o volume preenchido (R_rms~16, n_det~1200). Leitura: **caos → universo**, não “átomos falharam no ruído”. Mesma família de preenchimento que [19 triad_bigbang_solver_run](../Simula%C3%A7%C3%B5es/19%20triad_bigbang_solver_run.md).
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md) · `[[TRIAD]]`
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) nem [23 triad_memory_bounce_bigbang](../Simula%C3%A7%C3%B5es/23%20triad_memory_bounce_bigbang.md).
...
Equação TRIAD **completa** (mode=full) da spec canônica v1.0 [triad_equation_reference](triad_equation_reference.md) **A.2** R5-FDT. IC §9.1: **1 gaussiana = 1 átomo**, $s=0.5$, $k_0=0$, $y_j(0)=0$, $\int|\Psi|^2=1$. **Não é ablação.** Sem §6, sem zerar $\lambda$, sem fit de $k_*L$. [Memória](../Conceitos/Mem%C3%B3ria.md) · [FDT](../Conceitos/FDT.md) · [Universo como simulação](../Conceitos/Universo%20como%20simula%C3%A7%C3%A3o.md) · `[[Equação de referência]]`
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) nem [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md).
...
$k_*L$ late=9.424778 (casca não-DC mais baixa; igual ao [16 triad_R5_reference_N40](../Simula%C3%A7%C3%B5es/16%20triad_R5_reference_N40.md)). Spec §10.4 cita ~16.3 em N=128 — **não** calibrado aqui.
...
Com A.2 R5-FDT ($\Gamma=0.01$, $T_{\mathrm{bath}}=0.001$) a semente §9.1 permanece 1 átomo visível no t=0 e se espalha até preencher a caixa (R_rms 0.61→10.02, PR 1.97→4036, norma 1→2.816). Leitura: **1 átomo → universo no cubo**. Mesma família de preenchimento que [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) / [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md), IC canônico em vez da nuvem de 12. Este run **não** recalibrou FDT nem $k_*L$.
...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. Duas sementes, separação 6 ao longo de x. Leitura: par (queda?) e pico finito (singularidade que não vai a infinito). Volume preenchido = universo, não ruído. **Não** é teste de interferência. Sem isolar memória/FDT. Sem mudar Theta_core para o par atrair. [Leitura operacional](../Conceitos/Leitura%20operacional.md) · [Anti-colapso](../Conceitos/Anti-colapso.md) · [Universo como simulação](../Conceitos/Universo%20como%20simula%C3%A7%C3%A3o.md)

Solver: Strang 3D standalone (mesmo passo de [Fontes/run_q01a.py](../../source/Fontes/run_q01a.py) / [29 triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md)). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$.
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) · [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md) · [29 triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md) · Q01a.
...
Os dois átomos **permanecem 2 só até t=0.01**. Em t=0.02 o detector já conta 29–30 máximos e R_rms já é $\approx L/2$. Em t=0.1 n_raw=3603, norm=327 — a mesma família de preenchimento de Q01a / [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) com este banho. **Com kT=1 as duas sementes viram universo antes de um par-órbita poder ser lido.** kT não foi retocado. Isso é o resultado.
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md) · `[[TRIAD]]` · [Leitura operacional](../Conceitos/Leitura%20operacional.md)
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) · [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md) · [29 triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md) · [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) · Q01a.
...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. **OUTER larga = o universo** (um átomo gigante). **Dentro:** observador e observado, fases 0 e π (+ e −). Leitura: **anti-colapso / ímã-repele** (memória mesmo-polo, singularidade finita) — **não** MQ, **não** colapso-como-gravidade-caindo. Volume preenchido = universo, não ruído. Sem isolar memória/FDT. Sem mudar Theta_core. Sem retocar kT. [Leitura operacional](../Conceitos/Leitura%20operacional.md) · [Anti-colapso](../Conceitos/Anti-colapso.md) · [Universo como simulação](../Conceitos/Universo%20como%20simula%C3%A7%C3%A3o.md)

Solver: Strang 3D standalone (mesmo passo de [Fontes/run_q01a.py](../../source/Fontes/run_q01a.py) / [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) / [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md)). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$.
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) · [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md) · [29 triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md) · [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) · [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) · Q01a.
...
O par +/− **existe só em t=0**. Em t=0.01 o detector já conta milhares de extremos (n_raw_ρ=8608, n_raw_pos=9741, n_raw_neg=9250) e R_rms já é $\approx L/2$. Em t=0.02 n_raw_ρ=8636, norm=66.2 — a mesma família de preenchimento de [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) / [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) com este banho. **Com kT=1 o ninho 3 escalas dissolve em $t=0.01$; o volume preenchido continua o universo.** kT não foi retocado. Isso é o resultado.
...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md)). **I0 / environment**, não scan. 1 gaussiana = 1 átomo. **Inner atom INSIDE the outer atom**, mesmo centro. Outer fase 0 (+), inner fase π (−). Leitura: **ímã / anti-colapso** (ninho de sinal, singularidade finita) — **não** lado-a-lado como [32 universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md), **não** ninho mesmo-sinal como [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md). Volume preenchido = universo, não ruído. Sem isolar memória/FDT. Sem mudar Theta_core. Sem retocar kT. [Leitura operacional](../Conceitos/Leitura%20operacional.md) · [Anti-colapso](../Conceitos/Anti-colapso.md) · [Universo como simulação](../Conceitos/Universo%20como%20simula%C3%A7%C3%A3o.md)
...
Não substitui [27 triad_chaos_eq](../Simula%C3%A7%C3%B5es/27%20triad_chaos_eq.md) · [28 triad_atoms_3d](../Simula%C3%A7%C3%B5es/28%20triad_atoms_3d.md) · [29 triad_R5_A2](../Simula%C3%A7%C3%B5es/29%20triad_R5_A2.md) · [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) · [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) · [32 universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md) · Q01a.
...
O ninho **não morreu em t=0.02**. two-scale/oco permanece até **t=0.04**; em t=0.05 contrast_sf/oi caem abaixo do limiar. sign_nest operacional fica ligado até t=0.08 e **cai pela primeira vez em t=0.09**. Depois o flag **pisca** até t=1.0 (36 recordes; último fogo operacional t=1.0) sobre um cubo que **já é universo** desde t=0.01 (R_rms 2.52→15.77, norma 1→33.7 — a mesma família de preenchimento de [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) / [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) / [32 universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md)). **Com kT=1 o oco +/− concêntrico dissolve em $t\sim0.05$–$0.09$; o volume preenchido continua o universo.** kT não foi retocado. Isso é o resultado.
...
Não substitui [33 ninho_pm](../Simula%C3%A7%C3%B5es/33%20ninho_pm.md) · [32 universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md) · [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) · [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md).
...
Não substitui [30 dois_atomos_gravidade](../Simula%C3%A7%C3%B5es/30%20dois_atomos_gravidade.md) · [31 nested_gaussians](../Simula%C3%A7%C3%B5es/31%20nested_gaussians.md) · [32 universo_atomo](../Simula%C3%A7%C3%B5es/32%20universo_atomo.md) · [33 ninho_pm](../Simula%C3%A7%C3%B5es/33%20ninho_pm.md) · [34 ninho_pm_long](../Simula%C3%A7%C3%B5es/34%20ninho_pm_long.md) · Q00–Q04.
...
→ [Índice de runs](../Simula%C3%A7%C3%B5es/%C3%8Dndice%20de%20runs.md) · `[[TRIAD]]` · [Leitura operacional](../Conceitos/Leitura%20operacional.md) · [Anti-colapso](../Conceitos/Anti-colapso.md) · [átomo](../Conceitos/%C3%A1tomo.md)
...
Fonte do programa: [TRIAD_QM_BLUEPRINT](TRIAD_QM_BLUEPRINT.md). PDE: [triad_equation_reference](triad_equation_reference.md) · `[[Equação de referência]]`.
...
Feito. Arquivo imutável: [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md).
...
Canônico: [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md) (Q00).
...
Protocolo deste lote: [PROTOCOL_v2](../QM/Q02_ensemble/PROTOCOL_v2.md). Canônico: [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md) (Q00).
...
Protocolo: `[[PROTOCOL]]`. Canônico: [TRIAD_QM_CANONICAL_V1](TRIAD_QM_CANONICAL_V1.md) (Q00).
