> Reading copy / Cópia de leitura. Obsidian links converted for GitHub; original wording and recorded results retained. Unresolved references stay visible as code. [Original](../../source/Simula%C3%A7%C3%B5es/13%20triad_3d_longrun_compact.md) · [Collection / Acervo](../../README.md)

```yaml
tags: [triad, simulação, exploratória, 3d]
aliases: [triad_3d_longrun_compact]
classe: Exploratória 3D
diretório: triad_3d_longrun_compact
status: completo
run: 13
```
