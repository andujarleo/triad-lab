...
Antecede a [[Equação de referência]]. Campo 2D visual: duas entidades gaussianas + termo relacional. Quadro: [[Universo como simulação]].
...
![[Artefatos/triad_sim/00_montagem_simulacao.png]]
...
Primeira tentativa de NLS + [[Memória]] + [[FDT]]. Posteriormente revista em [[03 triad_nls_fdt_v2]]. Ainda não é o [[Solver]] da fase (c).
...
![[Artefatos/triad_nls_fdt/00_montagem.png]]
...
Saída visual de nuvem em evolução. Esta versão **antecede** a correção de manter identidades explicitamente separadas — ver [[05 triad_atoms_individual_fields]]. Sem CSV.

![[Artefatos/triad_atoms_gaussians/00_montagem.png]]
...
Correção metodológica sobre [[04 triad_atoms_gaussians]]: cada gaussiana mantém identidade própria. Campos podem se sobrepor/interagir sem fundir numa única identidade.
...
![[Artefatos/triad_atoms_individual_fields/00_montagem.png]]
...
Diretório sem arquivos. O teste foi refeito em [[07 triad_limit_test_fast]]. Mantido para não apagar a cronologia. Sem CSV, sem métrica.

Ver regra de integridade: [[Registro integral]].
...
Refaz [[06 triad_limit_test]]. Varredura N={2,4,8,12}, r={4,6,8}. Mede a_R, R0, Rfinal, deltaR.
...
Sem `00_montagem`. CSV: [[Artefatos/triad_limit_test_fast/limit_results.csv]]

### Arquivos

`01_heatmap.png` · `02_curves.png` · `03_N_scaling.png` · `04_r_scaling.png` · `05_summary.png` · `limit_results.csv`

![[Artefatos/triad_limit_test_fast/01_heatmap.png]]
...
Baseline vs observer_observed, com estado C operacional. Ver [[Observador e campo C]]. C não é interpretado como consciência.
...
![[Artefatos/triad_observer_observed_consciousness/00_montagem.png]]

CSV: [[Artefatos/triad_observer_observed_consciousness/summary.csv]]
...
→ [[09 triad_field_consciousness_test]] · [[Índice de runs]]
...
Baseline vs continuous_C. Acompanha campo C e correlação C–[[Memória]]. [[Observador e campo C]]. Sem bounce.
...
![[Artefatos/triad_field_consciousness_test/00_montagem.png]]

CSV: [[Artefatos/triad_field_consciousness_test/summary.csv]]
...
→ [[08 triad_observer_observed_consciousness]] · [[Bounce]] · [[Índice de runs]]
...
Passagem a 3D pelas limitações discutidas para 2D. Pré-referência estrita — não é o R5. Conceito: [[Anti-colapso]].
...
![[Artefatos/triad_3d_anticollapse_test/00_montagem.png]]
...
→ [[16 triad_R5_reference_N40]] · [[Índice de runs]]
...
Diretório sem arquivos. Resultados efetivos em [[12 triad_3d_longrun_fast]] e [[13 triad_3d_longrun_compact]]. Cronologia mantida. [[Registro integral]]
...
![[Artefatos/triad_3d_longrun_fast/01_trajectories.png]]

### Arquivos

`01_trajectories.png` · `02_radius.png` · `03_min_pair.png` · `04_order_cv.png` · `05_residual_motion.png`

→ [[13 triad_3d_longrun_compact]] · [[Índice de runs]]
...
Sem artefatos. Tentativa substituída por [[15 triad_R5_reference_fast]] / [[16 triad_R5_reference_N40]]. Sem CSV. Cronologia: [[Registro integral]].
...
Sem artefatos. Resultados efetivos começam em [[16 triad_R5_reference_N40]]. Sem CSV.
...
R5 full, N=48. Além de norm/peak/PR/k\*L/crystallinity: score angular Bravais. [[Rede Bravais]]
...
![[Artefatos/triad_R5_reference_N48_full/09_bravais_scores.png]]

### CSVs

- [[Artefatos/triad_R5_reference_N48_full/bravais_scores.csv]]
- [[Artefatos/triad_R5_reference_N48_full/metrics.csv]]

→ [[16 triad_R5_reference_N40]] · [[24 triad_bravais_map]]
...
22 painéis + montagem. No teste simples de cancelamento local **não** houve regiões $V_{\mathrm{mem}}\approx|\Lambda\rho|$. O [[Anti-colapso]] observado não se reduz a igualdade local. Sem CSV.

![[Artefatos/triad_visual_atlas/00_visual_atlas.png]]

### Painéis

`01_density_xy` … `22_balance_histogram` — lista em [[Artefatos/triad_visual_atlas/INDEX.txt]].

`08_memory_cubic_balance_xy.png` é o painel do balanço memória/cúbico.

→ [[16 triad_R5_reference_N40]] · [[Memória]] · [[Índice de runs]]
...
Primeiro run que carrega [[solver.py]] / `integrate_3d`. `ntri` → NumPy. [[Backend e unidades]]. FDT relativamente quente. **Falha de massa preservada.**
...
Crescimento de massa/norma associado ao FDT quente. Permanece. Motivou [[20 triad_bigbang_3d_box]].

![[Artefatos/triad_bigbang_solver_run/00_montagem.png]]

Animação 14.34 MB — **não embedada**; arquivo: `Artefatos/triad_bigbang_solver_run/10_bigbang_animation.gif`

### CSVs

- [[Artefatos/triad_bigbang_solver_run/summary.csv]]
- [[Artefatos/triad_bigbang_solver_run/metrics.csv]]

### Arquivos

`00_montagem.png` · `01_timeline_xy.png` … `09_memory_timeline_xy.png` · `10_bigbang_animation.gif` · `11_summary.png` + 2 CSVs

→ [[FDT]] · [[Registro integral]]
...
Protocolo refinado após a falha de [[21 triad_phase_to_density_speed]]. [[Phase-to-density]] · [[Solver]]
...
![[Artefatos/triad_phase_to_density_speed_refined/00_montagem.png]]

CSV: [[Artefatos/triad_phase_to_density_speed_refined/summary.csv]]
...
Contração → bounce de memória → expansão. **Nenhum termo explícito de bounce.** [[Bounce]] · [[Memória]] · [[Solver]]
...
![[Artefatos/triad_memory_bounce_bigbang/00_montagem.png]]

GIF 5.50 MB (abaixo de 10 MB): ![[Artefatos/triad_memory_bounce_bigbang/09_memory_bounce_animation.gif]]

### CSVs

- [[Artefatos/triad_memory_bounce_bigbang/summary.csv]]
- [[Artefatos/triad_memory_bounce_bigbang/refined_bounce_summary.csv]]
- [[Artefatos/triad_memory_bounce_bigbang/metrics.csv]]
...
Pós-proc: [[24 triad_bravais_map]] · [[25 triad_bravais_network_map]] · [[26 triad_bravais_network_map_v2]]
...
Pós-processamento de [[23 triad_memory_bounce_bigbang]] — sem reintegrar. FFT 3D da densidade, shell dominante, templates angulares. [[Rede Bravais]]
...
Melhor match: PLANAR_cross. Diferente do R5 N48, onde BCC foi o maior noutro detector/regime ([[17 triad_R5_reference_N48_full]]). Não unificar.

![[Artefatos/triad_bravais_map/00_montagem.png]]

### CSVs

- [[Artefatos/triad_bravais_map/bravais_final_scores.csv]]
- [[Artefatos/triad_bravais_map/bravais_scores_over_time.csv]]
...
Primeira rede: picos de densidade → nós; arestas por proximidade/kNN. Threshold severo demais. Preservado. Motivou [[26 triad_bravais_network_map_v2]]. [[Rede Bravais]]
...
![[Artefatos/triad_bravais_network_map/00_montagem.png]]

### CSVs

- [[Artefatos/triad_bravais_network_map/summary.csv]]
- [[Artefatos/triad_bravais_network_map/nodes.csv]]
- [[Artefatos/triad_bravais_network_map/edges.csv]]
...
Equação TRIAD **completa** (NLS + memória + FDT) a partir de uma nuvem de **12 átomos gaussianos**. 1 gaussiana = 1 átomo. Caos de átomos → o que assentar. **Não é ablação.** Sem controle sem-memória, sem V_harmônico de comparação, sem fit de k\*L. [[Bounce]] · [[FDT]] · [[Memória]]
...
CSV: [[Artefatos/triad_chaos_eq/atoms_ic.csv]]
...
Não é o IC de #23 (uma gaussiana larga σ=3.2 + chirp). Não substitui [[23 triad_memory_bounce_bigbang]].
...
Mesma família de [[19 triad_bigbang_solver_run]] (FDT quente; lá mass_final=8773.747757). Aqui o default `fdt_couple=True` com dx=1 injeta massa ~O(1) por passo; norma 1→25585.351298. #23 no mesmo Λ,ν,λ,Γ teve norma 1→1.491662 (N=40, IC diferente, FDT efetivo não registrado na nota). Este run **não** recalibrou FDT.

![[Artefatos/triad_chaos_eq/00_montagem.png]]

### O que os números sustentam

Com o FDT default em N=32, as 12 sementes deixam de ser o estado inteiro em Δt=0.1. O que assenta é o volume preenchido (R_rms~16, n_det~1200). Leitura: **caos → universo**, não “átomos falharam no ruído”. Mesma família de preenchimento que [[19 triad_bigbang_solver_run]].

### CSVs

- [[Artefatos/triad_chaos_eq/summary.csv]]
- [[Artefatos/triad_chaos_eq/metrics.csv]]
- [[Artefatos/triad_chaos_eq/atoms_ic.csv]]
...
Equação TRIAD **completa** (NLS + memória + FDT) a partir da mesma nuvem de **12 átomos gaussianos** do [[27 triad_chaos_eq]]. 1 gaussiana = 1 átomo. Caos de átomos → o que assentar. **Não é ablação.** Sem controle sem-memória, sem V_harmônico, sem fit de k\*L. [[Memória]] · [[FDT]] · [[Universo como simulação]]
...
CSV: [[Artefatos/triad_atoms_3d/atoms_ic.csv]]

![[Artefatos/triad_atoms_3d/01_atoms_3d_ic.png]]
...
![[Artefatos/triad_atoms_3d/02_isosurface_early.png]]
...
Não substitui [[27 triad_chaos_eq]] nem [[23 triad_memory_bounce_bigbang]].
...
![[Artefatos/triad_atoms_3d/03_isosurface_mid.png]]

![[Artefatos/triad_atoms_3d/04_isosurface_late.png]]

![[Artefatos/triad_atoms_3d/05_atoms_3d_traj.png]]

![[Artefatos/triad_atoms_3d/00_montagem.png]]

### O que os números sustentam

Com kT=0.001 da spec §A.2 as 12 sementes são **visíveis como blobs 3D no t=0** e seguem distintas ~1 unidade de tempo. O equilíbrio (n_det 12→971→1007, norma 1→23.275045, R_rms→16) é o universo preenchendo o volume — mais lento que [[27 triad_chaos_eq]], mesma leitura. Não é cubo de ruído. Este run **não** recalibrou FDT.

### CSVs

- [[Artefatos/triad_atoms_3d/summary.csv]]
- [[Artefatos/triad_atoms_3d/metrics.csv]]
- [[Artefatos/triad_atoms_3d/atoms_ic.csv]]
- [[Artefatos/triad_atoms_3d/centers.csv]]
...
Mesma IC de [[33 ninho_pm]], **T=60** (não T=8). Equação TRIAD **completa**, Theta_core congelado (Q00 / [[TRIAD_QM_CANONICAL_V1]]). **I0 / environment**, não scan. Pergunta: **depois que a caixa enche, acontece mais alguma coisa** (estrutura, rebirth de par, queda de pico, bounce, cristalinidade) **ou o cubo só senta como universo preenchido?** Volume preenchido = universo, não ruído. Sem isolar memória/FDT. Sem mudar Theta_core. Sem retocar kT. Não é prova de nada. [[Leitura operacional]] · [[Anti-colapso]] · [[Universo como simulação]]

Solver: Strang 3D standalone (cópia de [[Fontes/run_ninho_pm.py]] com `--T`). fp64, numpy. $V_{\mathrm{ext}}=0$, $y_j(0)=0$, caixa periódica $[-L/2,L/2)^3$. Seed=0.

### IC — ninho +/− concêntrico (idêntica ao run 33)

$\Psi = G_{\mathrm{out}}(s=2.0)_{(0,0,0)}^{\mathrm{fase}\,0} - G_{\mathrm{in}}(s=0.5)_{(0,0,0)}^{\mathrm{fase}\,\pi\,(=\,\times-1)}$, amplitudes cruas iguais, depois $\int|\Psi|^2\,dV=1$. Pico IC=0.014580, PR=141.559784, R_rms=2.522489. two_scale=sim (hollow), sign_nest=sim (hole_core). Até t=8 os números batem com [[33 ninho_pm]] (mesmo seed, mesmo passo).

![[Artefatos/triad_ninho_pm_long/01_ic_isosurface.png]]

![[Artefatos/triad_ninho_pm_long/01e_ic_re_isosurface.png]]

![[Artefatos/triad_ninho_pm_long/04g_midplane_re_t0.png]]
...
Não substitui [[33 ninho_pm]] · [[32 universo_atomo]] · [[31 nested_gaussians]] · [[30 dois_atomos_gravidade]].
...
![[Artefatos/triad_ninho_pm_long/04x_midplane_watch.png]]

![[Artefatos/triad_ninho_pm_long/04y_midplane_re_watch.png]]

![[Artefatos/triad_ninho_pm_long/01j_isosurface_t1.png]]

![[Artefatos/triad_ninho_pm_long/01k_isosurface_t8.png]]

![[Artefatos/triad_ninho_pm_long/01l_isosurface_t30.png]]

![[Artefatos/triad_ninho_pm_long/03_isosurface_late.png]]

![[Artefatos/triad_ninho_pm_long/05_observables.png]]

![[Artefatos/triad_ninho_pm_long/05b_after_fill.png]]

![[Artefatos/triad_ninho_pm_long/08_two_scale.png]]

![[Artefatos/triad_ninho_pm_long/00_montagem.png]]
...
- [[Artefatos/triad_ninho_pm_long/summary.csv]]
- [[Artefatos/triad_ninho_pm_long/metrics.csv]]
- [[Artefatos/triad_ninho_pm_long/radial_profiles.csv]]
- [[Artefatos/triad_ninho_pm_long/linecut_re.csv]]
- [[Artefatos/triad_ninho_pm_long/summary.json]]
...
Script: [[Fontes/run_ninho_pm_long.py]] (`--T` default 60)
...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [[TRIAD_QM_CANONICAL_V1]]). **I0 / environment**, não scan, **não** Q05, **não** teste de MQ. 1 gaussiana = 1 [[átomo]]. Volume preenchido = universo. Leitura: **singularidade = pico finito** (o ponto brilhante). Anti-colapso: Λ puxa, memória empurra, peak nunca Inf. Pergunta deste run: **enquanto o pico é finito, ele aperta (menos células, peak sobe), espalha (mais células), ou some no universo?** [[Leitura operacional]] · [[Anti-colapso]] · [[átomo]]
...
![[Artefatos/triad_singularidade_35/strip_1atom.png]]

![[Artefatos/triad_singularidade_35/strip_2atom.png]]
...
Não substitui [[30 dois_atomos_gravidade]] · [[31 nested_gaussians]] · [[32 universo_atomo]] · [[33 ninho_pm]] · [[34 ninho_pm_long]] · Q00–Q04.
...
![[Artefatos/triad_singularidade_35/peak_vs_t.png]]

![[Artefatos/triad_singularidade_35/width_vs_t.png]]

![[Artefatos/triad_singularidade_35/peak_vs_width.png]]

![[Artefatos/triad_singularidade_35/iso_1atom_t0_tpeak.png]]
...
- [[Artefatos/triad_singularidade_35/metrics_1atom.csv]]
- [[Artefatos/triad_singularidade_35/metrics_2atom.csv]]
- [[Artefatos/triad_singularidade_35/summary.json]]
...
Script: [[Fontes/run_singularidade_35.py]] (sha256 `923ecb0f1c4baf1db7ba2978e3977d3f7050f06c28bf387ddace88ab5c9caff7`)

→ [[Índice de runs]] · [[TRIAD]] · [[Leitura operacional]] · [[Anti-colapso]] · [[átomo]]
...
![[Artefatos/triad_reexecucao_36/A3/figures/peak_vs_t.png]]

![[Artefatos/triad_reexecucao_36/A3_N128/figures/peak_vs_t.png]]

![[Artefatos/triad_reexecucao_36/A3_N160/figures/peak_vs_t.png]]

![[Artefatos/triad_reexecucao_36/QM1D/figures/p1_interference.png]]

![[Artefatos/triad_reexecucao_36/CHSH/figures/chsh_bars.png]]

![[Artefatos/triad_reexecucao_36/CHSH/figures/E_vs_delta.png]]

![[Artefatos/triad_reexecucao_36/sidebands/figures/spectra.png]]

![[Artefatos/triad_reexecucao_36/tunnel_hist/figures/two_pass.png]]

![[Artefatos/triad_reexecucao_36/hotbath/figures/peak_vs_t.png]]

![[Artefatos/triad_reexecucao_36/kstar/figures/kL_vs_L.png]]

![[Artefatos/triad_reexecucao_36/bravais/figures/scores.png]]
...
Feito. Arquivo imutável: [[TRIAD_QM_CANONICAL_V1]].
...
Próximo: [[Q01]] convergência. Pilotos 1–29 não entram como evidência confirmatória.
...
Protocolo deste lote: [[PROTOCOL_v2]]. Canônico: [[TRIAD_QM_CANONICAL_V1]] (Q00).
Q01a/Q01b: [[Q01]] / [[Q01b]] — INCONCLUSIVE.
