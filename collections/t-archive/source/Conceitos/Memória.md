...
- $>0$ — memória **repulsiva**: suprime retorno a regiões já ocupadas → [[Anti-colapso]]
...
- Sem memória vs full: R5 N40 — peak_final 3.889202 vs 0.0006409; PR 0.528063 vs 4720.477435. [[16 triad_R5_reference_N40]]
- Atlas: sem regiões de $V_{\mathrm{mem}}\approx|\Lambda\rho|$. [[18 triad_visual_atlas]]
- Bounce: pico de densidade t=4.1, memória t=4.2, delay=0.1. [[23 triad_memory_bounce_bigbang]] · [[Bounce]]
- Campo C: `C_memory_corr_final=-0.3855089487747705` (continuous_C). [[09 triad_field_consciousness_test]] · [[Observador e campo C]]
