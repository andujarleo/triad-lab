...
[[21 triad_phase_to_density_speed]]. T_probe=1.8, ε=0.07, width=1.3.
...
[[22 triad_phase_to_density_speed_refined]]. Background T=12, kick ε=0.15, width=1.25, probe T=5, controle com a mesma sequência de ruído.
