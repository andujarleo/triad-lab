[Lab](../../README.md) · **English** · [Português](../pt-BR/history.md)
...
1,384 original content paths (initial lab + T archive) map to 1,169 unique payloads. **215 redundant paths were consolidated by exact hash.** Different contents with matching filenames remain separate. Historical documents now have a single location with GitHub-readable links; there is no separate reading-copy tree.

No simulation was rerun to replace a recorded result. Numerical code, arrays, configurations and figures retain their original bytes. Source-document link patches are reversible and auditable.

[Migration audit](../../provenance/layout-audit.md) · [Path ledger](../../provenance/layout-migration.json) · [Changes](../../CHANGELOG.md)
