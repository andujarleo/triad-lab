...
[21 triad_phase_to_density_speed](../../../simulations/signals/first-phase-to-density-diagnostic/notes/original-record.md). T_probe=1.8, ε=0.07, width=1.3.
...
[22 triad_phase_to_density_speed_refined](../../../simulations/signals/refined-phase-to-density-diagnostic/notes/original-record.md). Background T=12, kick ε=0.15, width=1.25, probe T=5, controle com a mesma sequência de ruído.
