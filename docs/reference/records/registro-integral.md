...
- [solver.py](../solver/solver.py) e [triad_equation_reference](triad-equation-reference.md) = anexos #2 e #111, sem edição.
- `Artefatos/conceitual/` = duas imagens **não** geradas pelo solver (p. 56):

![Artefatos/conceitual/a_large_infographic_cosmic_simulation_montage_on_a.png](../concept-illustrations/a-large-infographic-cosmic-simulation-montage-on-a.png)

![Artefatos/conceitual/evolução_cósmica_da_singularidade_à_teia_cósmica.png](../concept-illustrations/evolucao-cosmica-da-singularidade-a-teia-cosmica.png)
...
Voltar: `[[TRIAD]]` · [Índice de runs](indice-de-runs.md)
