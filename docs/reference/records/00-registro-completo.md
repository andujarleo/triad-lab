...
- [Índice 01–36 — Índice de runs](00-registro-completo.md)
- [Q00–Q04 — Programa QM](00-registro-completo.md)
...
Antecede a `[[Equação de referência]]`. Campo 2D visual: duas entidades gaussianas + termo relacional. Quadro: [Universo como simulação](../concepts/universe-as-simulation.md).
...
→ [Índice de runs](indice-de-runs.md) · [Memória](../concepts/memory.md) · [FDT](../concepts/fdt.md)
...
→ [Índice de runs](indice-de-runs.md) · [Memória](../concepts/memory.md)
...
Baseline vs observer_observed, com estado C operacional. Ver [Observador e campo C](../concepts/observer-and-c-field.md). C não é interpretado como consciência.
...
Baseline vs continuous_C. Acompanha campo C e correlação C–[Memória](../concepts/memory.md). [Observador e campo C](../concepts/observer-and-c-field.md). Sem bounce.
...
Passagem a 3D pelas limitações discutidas para 2D. Pré-referência estrita — não é o R5. Conceito: [Anti-colapso](../concepts/anti-collapse.md).
...
Regime R5 da `[[Equação de referência]]`. N=40 em vez de N=128 (custo CPU). Full vs no-memory. Classe (b). Conceito: [Anti-colapso](../concepts/anti-collapse.md) · [Memória](../concepts/memory.md).
...
R5 full, N=48. Além de norm/peak/PR/k\*L/crystallinity: score angular Bravais. [Rede Bravais](../concepts/bravais-lattice.md)
...
Primeiro run que carrega [solver.py](../solver/solver.py) / `integrate_3d`. `ntri` → NumPy. `[[Backend e unidades]]`. FDT relativamente quente. **Falha de massa preservada.**
...
→ [FDT](../concepts/fdt.md) · [Registro integral](registro-integral.md)
...
Primeira tentativa de kick de fase + frente. T_probe=1.8. **Estimador falhou.** Preservado. [Phase-to-density](../concepts/phase-to-density.md)
...
→ [Registro integral](registro-integral.md) · `[[Solver]]`
...
Contração → bounce de memória → expansão. **Nenhum termo explícito de bounce.** [Bounce](../concepts/bounce.md) · [Memória](../concepts/memory.md) · `[[Solver]]`
...
→ [Registro integral](registro-integral.md)
...
Equação TRIAD **completa** (NLS + memória + FDT) a partir de uma nuvem de **12 átomos gaussianos**. 1 gaussiana = 1 átomo. Caos de átomos → o que assentar. **Não é ablação.** Sem controle sem-memória, sem V_harmônico de comparação, sem fit de k\*L. [Bounce](../concepts/bounce.md) · [FDT](../concepts/fdt.md) · [Memória](../concepts/memory.md)
...
Equação TRIAD **completa** (mode=full) da spec canônica v1.0 [triad_equation_reference](triad-equation-reference.md) **A.2** R5-FDT. IC §9.1: **1 gaussiana = 1 átomo**, $s=0.5$, $k_0=0$, $y_j(0)=0$, $\int|\Psi|^2=1$. **Não é ablação.** Sem §6, sem zerar $\lambda$, sem fit de $k_*L$. [Memória](../concepts/memory.md) · [FDT](../concepts/fdt.md) · [Universo como simulação](../concepts/universe-as-simulation.md) · `[[Equação de referência]]`
...
Equação TRIAD **completa**, Theta_core congelado (Q00 / [TRIAD_QM_CANONICAL_V1](triad-qm-canonical-v1.md)). **I0 / environment**, não scan, **não** Q05, **não** teste de MQ. 1 gaussiana = 1 [átomo](../concepts/atom.md). Volume preenchido = universo. Leitura: **singularidade = pico finito** (o ponto brilhante). Anti-colapso: Λ puxa, memória empurra, peak nunca Inf. Pergunta deste run: **enquanto o pico é finito, ele aperta (menos células, peak sobe), espalha (mais células), ou some no universo?** [Leitura operacional](../concepts/operational-readings.md) · [Anti-colapso](../concepts/anti-collapse.md) · [átomo](../concepts/atom.md)
...
Fonte do programa: [TRIAD_QM_BLUEPRINT](triad-qm-blueprint.md). PDE: [triad_equation_reference](triad-equation-reference.md) · `[[Equação de referência]]`.
...
Feito. Arquivo imutável: [TRIAD_QM_CANONICAL_V1](triad-qm-canonical-v1.md).
