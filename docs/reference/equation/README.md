...
# Equation reference · document revisions

**One immutable equation.** The numbers below identify revisions of its written reference. They do not identify different TRIAD equations. Read the [project rules](../../en/project-rules.md) ([português](../../pt-BR/project-rules.md)) for the author’s method.

**Current author-supplied edition: [v1.1, dated 2026-09-13](v1.1.md).** It is preserved byte for byte. [Document revision 1.0](../records/triad-equation-reference.md) remains available as a historical document, in its existing location.
...
**Uma equação imutável.** Os números 1.0 e 1.1 identificam revisões do documento de referência, não equações diferentes. A edição fornecida pelo autor e vigente neste índice é a **[v1.1, de 2026-09-13](v1.1.md)**, copiada byte a byte. A **[v1.0](../records/triad-equation-reference.md)** continua preservada como referência histórica.
