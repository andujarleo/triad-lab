[Lab](README.md) · [English](../en/history.md) · **Português**
...
Os 1.384 caminhos originais de conteúdo (lab inicial + acervo T) correspondem a 1.169 conteúdos únicos. **215 caminhos redundantes foram consolidados por hash idêntico.** Conteúdos diferentes com o mesmo nome continuam separados. Os documentos históricos têm um único local com links legíveis no GitHub; não existe uma árvore paralela de cópias de leitura.

Nenhuma simulação foi reexecutada para substituir um resultado registrado. Código numérico, matrizes, configurações e figuras mantêm os bytes originais. As alterações de links nos documentos originais são reversíveis e auditáveis.

[Auditoria da migração](../../provenance/layout-audit.md) · [Registro de caminhos](../../provenance/layout-migration.json) · [Mudanças](../../CHANGELOG.md)
