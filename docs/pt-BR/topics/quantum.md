...
Esta é a sequência histórica de diagnósticos QM dentro da TRIAD. Os protocolos e vereditos originais foram preservados. A TRIAD é física quântica não padrão por sua identidade de projeto. Sua dinâmica completa e a leitura operacional do autor definem a abordagem; concordar com MQ padrão não é seu critério de identidade. [Entenda a TRIAD](../triad.md).
